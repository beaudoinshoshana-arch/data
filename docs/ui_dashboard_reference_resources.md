...
| Ant Design Pro Analysis Dashboard | https://preview.pro.ant.design/dashboard/analysis/；https://github.com/ant-design/ant-design-pro | 借鉴企业级后台的指标卡、图表区和表格明细层级，但保留污水厂监控大屏的暗色运行态 |
