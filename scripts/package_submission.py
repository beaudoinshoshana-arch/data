...
INCLUDE_FILES = [
    ...
    "outputs/fusion_data/high_frequency_source_catalog.csv",
    "outputs/fusion_data/high_frequency_sample.csv",
    "outputs/minute_simulation/summary.json",
    "outputs/minute_simulation/minute_simulation_report.md",
    "outputs/minute_simulation/minute_control_replay_sample.csv",
    ...
    "scripts/run_minute_level_simulation.py",
