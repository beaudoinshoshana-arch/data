...
const children = [
  ...
  bullet("论文依据与创新对照表：docs/literature_basis_table.md。"),
  bullet("系统对接手册：docs/system_integration_manual.md。"),
  bullet("部署运行说明：docs/deployment_guide.md。"),
  bullet("演示脚本：docs/demo_script.md。"),
];
